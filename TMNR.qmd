...
3.  Provide recommendations on actions and strategies that the BKHC can undertake in order to promote sustainable management of the TMNR and increase community awareness, engagement, attitudes and practices.

4.  Establish a baseline through which future interventions and strategies can be measured against.
...
head_ind_descriptives2 <- head_descriptives2 |> 
  ...
  gtsave(
    ...
    filename = paste0(str_sub('descriptives'), '.docx'),
    path = './tables'
  )
